-- Drop existing user_roles table (this will delete existing role data)
...
create policy "Admins view all" on public.profiles for select to authenticated using (public.has_role(auth.uid(), 'admin'));