...
interface CustomMyAddressesIconProps {
  className?: string;
}

const CustomMyAddressesIcon: React.FC<CustomMyAddressesIconProps> = ({ className = "w-5 h-5" }) => {
  return (
...
export default CustomMyAddressesIcon;