...
const ProfileSettingsDialog: React.FC<ProfileSettingsDialogProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[999999] isolate overflow-hidden pointer-events-auto" data-ps-root>
      ...
      {/* Windows container */}
      <div className="relative w-[1040px] h-[calc(100vh-120px)] overflow-visible absolute left-1/2 transform -translate-x-1/2 z-[1000000] pointer-events-auto" style={{ top: '80px' }}>
