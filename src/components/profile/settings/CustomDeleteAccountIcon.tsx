...
interface CustomDeleteAccountIconProps {
  className?: string;
}

const CustomDeleteAccountIcon: React.FC<CustomDeleteAccountIconProps> = ({ className = "w-5 h-5" }) => {
  return (
    <svg 
...
export default CustomDeleteAccountIcon;