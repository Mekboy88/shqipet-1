...
interface CustomSessionsIconProps {
  className?: string;
}

const CustomSessionsIcon: React.FC<CustomSessionsIconProps> = ({ className = "w-5 h-5" }) => {
  return (
    <svg viewBox="0 0 500 500" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Mobile device */}
      <path style={{opacity:0.2, fill:"#B5C6C6"}} d="M436.4,77.6H266c-10.4,0-18.4,8.8-18.4,20.8V448 c0,11.2,8,20.8,18.4,20.8h170.4c10.4,0,18.4-8.8,18.4-20.8V98.4C454.8,87.2,446.8,77.6,436.4,77.6z" />
      ...
      {/* Mobile screen */}
      <path style={{opacity:0.3, fill:"#2B545B"}} d="M461.2,141.6H319.6c-7.2,0-13.6,6.4-13.6,14.4v295.2 c0,8,5.6,8,13.6,8h141.6c7.2,0,13.6,0,13.6-8v-296C474.8,148,468.4,141.6,461.2,141.6z" />
...
export default CustomSessionsIcon;