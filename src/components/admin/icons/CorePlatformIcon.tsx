...
interface CorePlatformIconProps {
  className?: string;
}

const CorePlatformIcon: React.FC<CorePlatformIconProps> = ({ className = "h-4 w-4" }) => {
  return (
    <svg 
      version="1.1" 
    ...
    >
      ...
      <polygon points="424.74,457.584 414.948,447.8 418.636,444.112 424.316,449.784 435.412,435.960 439.476,439.216"/>
    </svg>
  );
};

export default CorePlatformIcon;