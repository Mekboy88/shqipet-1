...
const PostIntentSection: React.FC<PostIntentSectionProps> = ({ selectedIntent, onSelectIntent }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        {/* Pulsing Glow Ring */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 opacity-75 blur-md animate-pulse" />
        
        {/* Main Button */}
        <div className="relative flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full shadow-lg">
          <Folder className="w-5 h-5 text-white animate-pulse" />
