...
export const WarningIcon: React.FC<WarningIconProps> = ({ className }) => {
  return (
    ...
    >
      <defs>
        <linearGradient id="warningGrad1" gradientUnits="userSpaceOnUse" x1="68" y1="-1808.36" x2="68" y2="-1887.05" gradientTransform="matrix(1 0 0 -1 -3.64 -1776.09)">
          <stop offset="0" stopColor="#424242" />
          <stop offset="1" stopColor="#212121" />
        </linearGradient>
        <linearGradient id="warningGrad2" gradientUnits="userSpaceOnUse" x1="64.36" y1="-1808.36" x2="64.36" y2="-1887.05" gradientTransform="matrix(1 0 0 -1 0 -1772.11)">
          <stop offset="0" stopColor="#424242" />
          <stop offset="1" stopColor="#212121" />
        </linearGradient>
      </defs>
      ...
      <path d="M64.36 34.02c4.6 0 8.3 3.7 8 8l-3.4 48c-.38 2.54-2.74 4.3-5.28 3.92a4.646 4.646 0 0 1-3.92-3.92l-3.4-48c-.3-4.3 3.4-8 8-8z" fill="url(#warningGrad1)" />
      <circle cx="64.36" cy="104.02" r="6" fill="url(#warningGrad2)" />
