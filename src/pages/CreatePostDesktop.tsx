              ...
              <CollapsibleContent className="mt-2 space-y-3 p-3 bg-muted/30 rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm flex items-center gap-0">
                    Allow Reactions
                    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 inline-block ml-1">
                    ...
                    <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 inline-block -ml-0.5" transform="matrix(-1, 0, 0, 1, 0, 0)">
                    ...
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 inline-block -ml-0.5">
                    ...
                    <svg viewBox="0 0 511.999 511.999" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 inline-block -ml-0.5">
